...
def test_my_cases_3():
    assert maxPoints([[0, 0], [1, 2], [2, 4]]) == 3
...
def test_wa1():
    assert maxPoints([[0, 0], [1, -1], [1, 1]]) == 2
    assert maxPoints([[-783, -667], [-870, -747], [87, 133], [0, 53],
                      [261, 293], [-609, -507], [-435, -347], [870, 853],
                      [435, 453], [609, 613], [174, 213], [-261, -187],
                      [-348, -267], [-87, -27], [-174, -107], [783, 773], [696, 693]]) == 17
